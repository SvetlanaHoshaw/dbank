...
public class SauceLabParallelTesting {
    public static void main(String[] args) throws MalformedURLException {
//in this method we change only platform to  Platform.MOJAVE and browser to safari
//RUN THIS AND AT THE SAME TIME RUN ANOTHER SAUCELAB CLASS and
        //you will see in sauce lab that they are both running
...
//these all settings to run test remotely
        ...
        capabilities.setCapability("platformName", Platform.MOJAVE); //will use Windows 10 ro run in Sause lab
        capabilities.setCapability("browserName", BrowserType.SAFARI); //will use Chrome browser to run in Sauce Lab
